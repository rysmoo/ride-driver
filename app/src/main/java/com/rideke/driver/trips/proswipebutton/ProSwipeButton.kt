package com.rideke.driver.trips.proswipebutton
...
import com.rideke.driver.trips.proswipebutton.Constants.BTN_INIT_RADIUS
import com.rideke.driver.trips.proswipebutton.Constants.BTN_MORPHED_RADIUS
import com.rideke.driver.trips.proswipebutton.Constants.DEFAULT_SWIPE_DISTANCE
import com.rideke.driver.trips.proswipebutton.Constants.DEFAULT_TEXT_SIZE
import com.rideke.driver.trips.proswipebutton.Constants.MORPH_ANIM_DURATION
import com.rideke.driver.trips.proswipebutton.UiUtils.animateFadeHide
import com.rideke.driver.trips.proswipebutton.UiUtils.animateFadeShow
import com.rideke.driver.trips.proswipebutton.UiUtils.dpToPx
...
class ProSwipeButton : RelativeLayout {
    ...
    private fun setAttrs(context: Context, attrs: AttributeSet) {
        ...
        try {
            ...
            if (btnString != null)
                btnText = btnString
            textColorInt = a.getColor(R.styleable.ProSwipeButton_text_color, ContextCompat.getColor(context, R.color.cabme_app_black))
            bgColorInt = a.getColor(R.styleable.ProSwipeButton_bg_color, ContextCompat.getColor(context, R.color.cabme_app_yellow))
