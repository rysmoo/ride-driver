...
import com.rideke.driver.common.util.Enums.REQ_CASH_COLLECTED
import com.rideke.driver.common.util.Enums.REQ_GET_INVOICE
...
import com.rideke.driver.home.datamodel.InvoiceModel
import com.rideke.driver.home.datamodel.TripInvoiceModel
...
class PaymentAmountPage : CommonActivity(), ServiceListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setTextColor(ContextCompat.getColor(this, R.color.primary_button_text_color))
   ...
   */
    fun loaddata() {
        ...
        if (CommonKeys.TripStatus.Completed == payment_status) {
            button.setTextColor(resources.getColor(R.color.primary_button_text_color))
            //   button.setTextColor(resources.getColor(R.color.ub__contact_resolved_green))
            button.setBackground(ContextCompat.getDrawable(applicationContext, R.drawable.app_curve_button_yellow))
        ...
        if (payment_method!!.contains("cash", ignoreCase = true)) {
            if (java.lang.Float.valueOf(total_fare!!) > 0) {
                ...
                button.setTextColor(resources.getColor(R.color.primary_button_text_color))
                button.setBackground(ContextCompat.getDrawable(applicationContext, R.drawable.app_curve_button_yellow_disable))
                    ...
                    if (JSON_DATA != null) {
                        ...
                        try {
                            ...
                            if (jsonObject.getJSONObject("custom").has("trip_payment")) {
                                ...
                                //button.setTextColor(resources.getColor(R.color.ub__contact_resolved_green))
                                button.setTextColor(resources.getColor(R.color.primary_button_text_color))
                                /*button.background = ContextCompat.getDrawable(applicationContext, R.drawable.app_curve_button_yellow)
                                button.isEnabled = true*/
