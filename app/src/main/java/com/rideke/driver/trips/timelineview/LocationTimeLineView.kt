package com.rideke.driver.trips.timelineview
...
class LocationTimeLineView(private val context: Context, private val addressList: ArrayList<String>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (position == 1) {
            ...
            holder.vCircle.setColorFilter(ContextCompat.getColor(context, R.color.cabme_app_yellow), android.graphics.PorterDuff.Mode.SRC_IN)
        } else {
