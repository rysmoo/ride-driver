package com.rideke.driver.google.locationmanager
...
import com.rideke.driver.common.helper.Constants.notificationIcon
...
class TrackingService : Service(){
    ...
    private val timerInterval: Long = 5000 // 5 seconds
    ...
    override fun onCreate() {
        ...
        mFirebaseDatabaseRequest = mFirebaseInstance.getReference(applicationContext.getString(com.rideke.driver.R.string.real_time_db))
        ...
        runnable = object : Runnable {
            override fun run() {
                ...
                Log.i(TAG, "sessionManager.bubbleClosedViaUser=${sessionManager.bubbleClosedViaUser}")
                if (commonMethods.isAppOnForeground(this@TrackingService)) {
                    Log.i(TAG, "Application is running")
                    checkButtonServiceStatus(true)
                } else {
                    Log.i(TAG, "Application is not running")
                    if (!sessionManager.bubbleClosedViaUser!!) {
                        checkButtonServiceStatus(false)
                    }
    ...
    private fun startMyOwnForeground() {
        ...
        val notification = notificationBuilder.setOngoing(true)
                ...
                .setColor(ContextCompat.getColor(this,R.color.cabme_app_black))
                .build()
