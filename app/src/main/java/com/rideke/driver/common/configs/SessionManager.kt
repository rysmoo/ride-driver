package com.rideke.driver.common.configs
...
class SessionManager {
    ...
    var payoutLimit: String?
        get() = sharedPreferences.getString("payoutLimit", "0")
        set(payoutLimit) = sharedPreferences.edit().putString("payoutLimit", payoutLimit!!).apply()
    ...
    var oweAmount: String?
        get() = sharedPreferences.getString("oweAmount", "0")
    ...
    var paypalEmail: String?
        get() = sharedPreferences.getString("PaypalEmail", "0")
    ...
    var vehicleTypeId: String
        get() = sharedPreferences.getString("vehicleTypeId", "").toString()
        set(vehicleTypeId) = sharedPreferences.edit().putString("vehicleTypeId", vehicleTypeId).apply()

    var bubbleClosedViaUser: Boolean
        get() = sharedPreferences.getBoolean("bubble_closed_via_user", false)
        set(bubbleClosedViaUser) = sharedPreferences.edit().putBoolean("bubble_closed_via_user", bubbleClosedViaUser).apply()
