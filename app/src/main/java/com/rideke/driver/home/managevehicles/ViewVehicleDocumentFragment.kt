...
import com.rideke.driver.common.util.Enums.UPLOAD_VEHICLE_DOCUMENT
import com.rideke.driver.common.util.RequestCallback
import com.rideke.driver.common.util.RuntimePermissionDialogFragment
import com.rideke.driver.databinding.ViewDocumentLayoutBinding
import com.rideke.driver.home.datamodel.AddDocumentDetails
   ...
   */
    ...
    private fun onSelectFromGalleryResult(data: Intent?) {
        ...
        if (data != null) {
            ...
            tvTapToAdd.setText(requireContext().resources.getString(R.string.taptochange))
