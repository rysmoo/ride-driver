...
import com.rideke.driver.home.datamodel.LoginDetails
...
class SigninActivity : CommonActivity(), ServiceListener {
  ...
  /*  @BindView(R.id.dochome_back)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.isEnabled = false
        button.background = resources.getDrawable(R.drawable.app_curve_button_yellow_disable)
    ...
    private inner class NameTextWatcher(private val view: View) : TextWatcher {
        ...
        override fun onTextChanged(charSequence: CharSequence, i: Int, i1: Int, i2: Int) {
            if (validateLast("validate") && validateMobile("validate")) {
                ...
                button.background = resources.getDrawable(R.drawable.app_curve_button_yellow)
            } else {
