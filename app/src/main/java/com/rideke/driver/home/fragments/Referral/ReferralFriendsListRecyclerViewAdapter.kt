package com.rideke.driver.home.fragments.Referral
...
import com.rideke.driver.home.datamodel.CompletedOrPendingReferrals
import com.rideke.driver.common.util.CommonKeys

import com.rideke.driver.common.util.CommonKeys.CompletedReferralArray
import com.rideke.driver.common.util.CommonKeys.IncompleteReferralArray
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (referralArrayType == IncompleteReferralArray) {
            ...
            if (referredFriendsModelArrayListSingleObject.status == CommonKeys.ReferralStatus.Expired) {
                holder.tvRemainingDaysAndTrips.setTextColor(ContextCompat.getColor(mContext,R.color.cabme_app_yellow))
