package com.rideke.driver.home.earning

/**
 * @package com.cloneappsolutions.cabmedriver.home.earning
 * @subpackage earning
 * @category BarView
...
import com.rideke.driver.common.helper.MyUtils
...
class BarView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : View(context, attrs) {
    ...
    private val FOREGROUND_COLOR = Color.parseColor("#F6C92E")
